...
// Identifier for beacon (follows AltBeacon pseudostandard)
static const uint8_t beacon_id[] = {
    0x02, 0x01, 0x06, 0x1B, 0xFF, BEACON_MFG_ID, 0xBE, 0xAC
};
static const uint8_t beacon_id_len = sizeof(beacon_id);


static void client_start(void){
    DEBUG_LOG("Start scanning!\n");
    state = TC_W4_SCAN_RESULT;
    gap_set_scan_parameters(0,0x030, 0x0030);
    gap_start_scan();
}
